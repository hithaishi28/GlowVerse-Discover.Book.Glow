...
export function Toast({ message }) {
  ...
  if (success) {
    return (
      <div role="status" className="fixed bottom-6 left-1/2 z-[9999] flex min-h-16 w-[min(92vw,420px)] -translate-x-1/2 items-center gap-4 rounded-2xl border border-sage/30 bg-white px-5 py-4 text-ink shadow-glow dark:bg-ink dark:text-white">
